...
require "admin/trainees_controller"

describe Admin::TraineesController, type: :controller do
  ...
  describe "GET /courses/:course_id/trainees" do
    ...
    it "renders the admin/trainees/index template" do
      sign_in supervisor
      get :index, course_id: course.id
      expect(response).to render_template("admin/trainees/index")
